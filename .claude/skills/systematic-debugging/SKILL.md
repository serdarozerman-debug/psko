...
> **When to invoke:** When encountering ANY bug, test failure, or unexpected behavior. Before proposing fixes.
> **Used by:** All builder agents (Smith, Shaper, Alchemist) and Enforcer.

## Purpose

Find root causes before attempting fixes. Random fixes waste time and create new bugs.
...
BEFORE proposing any fix:
  Ask: "Have I completed Phase 1?"

  IF no:
    STOP — investigate root cause first

  Ask: "Can I state the root cause clearly?"

  IF no:
    STOP — you don't understand the problem yet

  Ask: "Am I on fix attempt #3+?"

  IF yes:
    STOP — escalate, don't fix again
```
